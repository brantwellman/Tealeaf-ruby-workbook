...
def fun_with_ids
  ...
  # b_outer is forty-two with an id of: 70214067263520 before the block.
  # c_outer is [42] with an id of: 70214067201680  before the block.
  ...
  1.times do
    ...
    # All object_id's remained the same
    ...
    # all object_id's are reassigned
...
# the object_id's for the variables inside the block remain the same, but the variables defined inside of the block are now gone.
